...
public class AlumnosServiceImpl implements AlumnosService {
	...
	public boolean altaAlumno(Alumno alumno, int idCurso ) {
		Curso curso=daoCursos.findById(idCurso).orElse(null);//optional recoge un or else para eliminar fallo
		if(daoAlumnos.findById(alumno.getDni()).orElse(null)==null&&curso!=null) {
